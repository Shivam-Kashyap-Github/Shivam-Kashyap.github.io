...
// Detailed World Regions with Country Labels
const worldRegions = [
    {
        name: 'USA',
        label: { x: 0.18, y: 0.28 },
        points: [
            { x: 0.10, y: 0.15 }, { x: 0.13, y: 0.17 }, { x: 0.16, y: 0.19 }, { x: 0.20, y: 0.18 },
            { x: 0.24, y: 0.20 }, { x: 0.28, y: 0.24 }, { x: 0.30, y: 0.30 }, { x: 0.28, y: 0.35 },
            { x: 0.24, y: 0.38 }, { x: 0.20, y: 0.37 }, { x: 0.16, y: 0.34 }, { x: 0.13, y: 0.30 },
            { x: 0.11, y: 0.25 }, { x: 0.10, y: 0.20 }, { x: 0.10, y: 0.15 }
        ]
    },
    {
        name: 'BRAZIL',
        label: { x: 0.27, y: 0.62 },
        points: [
            { x: 0.23, y: 0.48 }, { x: 0.26, y: 0.50 }, { x: 0.30, y: 0.53 }, { x: 0.33, y: 0.58 },
            { x: 0.34, y: 0.64 }, { x: 0.32, y: 0.70 }, { x: 0.29, y: 0.74 }, { x: 0.26, y: 0.75 },
            { x: 0.23, y: 0.72 }, { x: 0.21, y: 0.67 }, { x: 0.21, y: 0.61 }, { x: 0.22, y: 0.55 },
            { x: 0.23, y: 0.48 }
        ]
    },
    {
        ...
        label: { x: 0.47, y: 0.22 },
        points: [
            { x: 0.44, y: 0.18 }, { x: 0.47, y: 0.19 }, { x: 0.50, y: 0.21 }, { x: 0.51, y: 0.24 },
            { x: 0.50, y: 0.27 }, { x: 0.47, y: 0.28 }, { x: 0.44, y: 0.26 }, { x: 0.43, y: 0.22 },
            { x: 0.44, y: 0.18 }
        ]
    },
    {
        ...
        label: { x: 0.52, y: 0.24 },
        points: [
            { x: 0.50, y: 0.20 }, { x: 0.53, y: 0.21 }, { x: 0.56, y: 0.23 }, { x: 0.57, y: 0.26 },
            { x: 0.56, y: 0.29 }, { x: 0.53, y: 0.30 }, { x: 0.50, y: 0.28 }, { x: 0.49, y: 0.24 },
            { x: 0.50, y: 0.20 }
        ]
    },
    {
        ...
        label: { x: 0.52, y: 0.42 },
        points: [
            { x: 0.49, y: 0.37 }, { x: 0.52, y: 0.38 }, { x: 0.55, y: 0.40 }, { x: 0.56, y: 0.44 },
            { x: 0.55, y: 0.48 }, { x: 0.52, y: 0.49 }, { x: 0.49, y: 0.47 }, { x: 0.48, y: 0.42 },
            { x: 0.49, y: 0.37 }
        ]
    },
    {
        ...
        label: { x: 0.52, y: 0.66 },
        points: [
            { x: 0.48, y: 0.58 }, { x: 0.51, y: 0.59 }, { x: 0.54, y: 0.61 }, { x: 0.56, y: 0.65 },
            { x: 0.55, y: 0.69 }, { x: 0.52, y: 0.71 }, { x: 0.49, y: 0.69 }, { x: 0.47, y: 0.65 },
            { x: 0.48, y: 0.58 }
        ]
    },
    {
        ...
        label: { x: 0.68, y: 0.22 },
        points: [
            { x: 0.58, y: 0.15 }, { x: 0.65, y: 0.16 }, { x: 0.72, y: 0.18 }, { x: 0.78, y: 0.20 },
            { x: 0.84, y: 0.22 }, { x: 0.88, y: 0.26 }, { x: 0.87, y: 0.32 }, { x: 0.82, y: 0.35 },
            { x: 0.76, y: 0.36 }, { x: 0.70, y: 0.35 }, { x: 0.64, y: 0.32 }, { x: 0.59, y: 0.28 },
            { x: 0.57, y: 0.23 }, { x: 0.58, y: 0.18 }, { x: 0.58, y: 0.15 }
        ]
    },
    {
        name: 'INDIA',
        label: { x: 0.72, y: 0.40 },
        points: [
            { x: 0.68, y: 0.30 }, { x: 0.71, y: 0.32 }, { x: 0.74, y: 0.35 }, { x: 0.76, y: 0.39 },
            { x: 0.76, y: 0.44 }, { x: 0.74, y: 0.48 }, { x: 0.71, y: 0.49 }, { x: 0.68, y: 0.47 },
            { x: 0.66, y: 0.43 }, { x: 0.66, y: 0.38 }, { x: 0.67, y: 0.33 }, { x: 0.68, y: 0.30 }
        ]
    },
    {
        name: 'CHINA',
        label: { x: 0.78, y: 0.30 },
        points: [
            { x: 0.72, y: 0.22 }, { x: 0.76, y: 0.24 }, { x: 0.80, y: 0.26 }, { x: 0.84, y: 0.29 },
            { x: 0.86, y: 0.33 }, { x: 0.85, y: 0.38 }, { x: 0.82, y: 0.41 }, { x: 0.78, y: 0.42 },
            { x: 0.74, y: 0.40 }, { x: 0.71, y: 0.36 }, { x: 0.70, y: 0.31 }, { x: 0.71, y: 0.26 },
            { x: 0.72, y: 0.22 }
        ]
    },
    {
        ...
        label: { x: 0.83, y: 0.66 },
        points: [
            { x: 0.76, y: 0.58 }, { x: 0.80, y: 0.59 }, { x: 0.85, y: 0.62 }, { x: 0.89, y: 0.66 },
            { x: 0.90, y: 0.71 }, { x: 0.88, y: 0.75 }, { x: 0.83, y: 0.76 }, { x: 0.78, y: 0.74 },
            { x: 0.75, y: 0.70 }, { x: 0.74, y: 0.65 }, { x: 0.75, y: 0.61 }, { x: 0.76, y: 0.58 }
        ]
    }
];
